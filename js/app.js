(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            ...
            if (e.target.closest(".menu__link") || e.target.closest(".menu__btn") || e.target.closest(".contacts__link")) functions_menuClose();
        }));
    }
    ...
    function initSliders() {
        const swiperSlider = document.querySelectorAll(".results__slider");
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        ...
        const checkedRadio = document.querySelector(".option-block__input:checked");
        if (checkedRadio) toggleFields(checkedRadio.value);
